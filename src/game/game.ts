...
export class Game {
		...
		this.tutorial = [
			{
				section: 'view',
				target: this.$view,
				text: 'This is the overview of your country. <strong>Build nuclear reactors by dragging them onto the view and manage them by clicking.</strong>',
				direction: 'center'
			},
			{
				section: 'status',
			...
			},
			{
				...
				text: 'Nuclear reactors are measured in units of electricity called megawatts. Surprisingly, the amount of megawatts produced in one hour is called a megawatt-hour. <strong>This is the total amount of megawatt-hours generated by nuclear in your country.</strong>',
				direction: 'top'
			},
			{
				section: 'status',
			...
			},
			{
				...
				text: 'This is how much money you gain per (in game) hour. <strong>You get more money depending on how much the public likes nuclear energy.</strong> The public likes nuclear the closer/longer they live by a nuclear reactor. <strong>You also gain more money if the oil prices increase.</strong>',
				direction: 'top'
			},
			{
				section: 'buy',
				target: this.$buy,
				text: 'This is the shop where you can buy nuclear reactors. <strong>Build one by dragging the desired reactor onto your country.</strong>',
				direction: 'right'
			},
			{
				section: 'all',
				target: this.$game,
				text: 'Again, the goal of the game is to convert your country to 100% nuclear energy! Good luck!',
				direction: 'center'
			}
		];
	...
	startTutorial(i = 0) {
		this.tutorialTextBox(this.tutorial[i], i + 1, () => {
			i++;
			if (this.tutorial[i]) {
	...
	tutorialTextBox(tutorial: Tutorial, index: number, callback?: () => any) {
		...
		$(`#tutorial-${id} button`).click(event => {
			$target.popover('hide');
			this.focus('all');
