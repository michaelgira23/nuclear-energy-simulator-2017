		...
		this.tutorial = [
			{
				section: 'view',
				target: this.$view,
				text: '<strong>Welcome to Nuclear Energy Simulator 2017!</strong> This is the overview of your country and you are the president. The goal of the game is to convert your country to 100% nuclear. Along the way, you will encounter some of the political, social, and economic challenges that come with the adoption of nuclear energy.',
				direction: 'center'
			},
			// {
			// 	section: 'status',
			...
			// 	text: 'The energy production of nuclear reactors are measured in units of electricity called megawatts (MW). Surprisingly, the amount of megawatts produced in one hour is called a megawatt-hour (MWh). <strong>This is the total amount of megawatt-hours generated by nuclear in your country.</strong>',
			// 	direction: 'top'
			// },
			// {
			// 	section: 'status',
